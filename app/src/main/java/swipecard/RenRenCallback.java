...
import static swipecard.CardConfig.MAX_SHOW_COUNT;
import static swipecard.CardConfig.SCALE_GAP;
import static swipecard.CardConfig.TRANS_Y_GAP;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (level > 0) {
                ...
                if (level < MAX_SHOW_COUNT - 1) {
                    ...
                    //最后一层的显示过程
                    child.setTranslationX(TRANS_Y_GAP * (level - 1));
                    child.setScaleX(1 - SCALE_GAP * (level - 1));
                }
            }
        }
    }
